...
public class NavigatorState extends BasicNavigator {
	...
	public NavigatorState(Odometer odo) {
		super(odo);
	...
	public void goForward(double distance, boolean avoid) {
		double x = odometer.getX()
				+ Math.cos(Math.toRadians(this.odometer.getAngJ())) * distance;
		double y = odometer.getY()
				+ Math.sin(Math.toRadians(this.odometer.getAngJ())) * distance;
