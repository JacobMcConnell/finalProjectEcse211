...
/**
 * This class is used for navigating the navigator accros the board depending on the placement of
 * the tunnel,the starting corner and the startset. It allows to navigate from the starting point to
 * the startset through the tunnel and go back to the starting point
 *
 * @author Erdong Luo
 * 
 */
public class TN_navigator extends Thread {
  ...
  /**
   * A method to drive our vehicle to the tunnel Travels to the closest point to the tunnel
   */
  ...
  /**
   * A method to turn the navigator to the inside and place itself to enter the tunnel entrance
   * 
   */
  ...
  /**
   * A method to turn to one of the two closest intersection of the tunnel It will turn to the one
   * closest to the startset or the starting corner It is used after traveling the tunnel (tunnel
   * exit)
   * 
   */
