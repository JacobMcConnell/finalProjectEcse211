  ...
  public void initialize(int startingCorner) {
    switch (startingCorner) {
      case 0:
        nbXLines = 1;
        nbYLines = 1;
        odo.setXYT(nbXLines * TILE_SIZE, nbYLines * TILE_SIZE, 0);
        break;
      case 1:
        nbXLines = 14;
        nbYLines = 1;
        odo.setXYT(nbXLines * TILE_SIZE, nbYLines * TILE_SIZE, 270);
        break;
      case 2:
        nbXLines = 14;
        nbYLines = 8;
        odo.setXYT(nbXLines * TILE_SIZE, nbYLines * TILE_SIZE, 180);
        break;
      case 3:
        nbXLines = 1;
        nbYLines = 8;
        odo.setXYT(nbXLines * TILE_SIZE, nbYLines * TILE_SIZE, 90);
        break;
    }
