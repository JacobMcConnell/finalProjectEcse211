...
/**
 * Modified from WifiExample. Sets all of the public variables for the final project using data from
 * the server.
 * 
 */
public class WiFiClass {
  ...
  /**
   * BETA DEMO Gets the starting corner coordinates of your team. coords(x,y)
   * 
  ...
  /**
   * Determines the orientation of the tunnel vertical(along y axis) horizontal(along x-axis)
   * 
